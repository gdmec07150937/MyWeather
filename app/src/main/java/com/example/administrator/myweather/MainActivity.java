...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton refershBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refershBtn = (ImageButton) this.findViewById(R.id.refresh);
    ...
    private void initChooseDialog(){
        ...
        ArrayAdapter<String> provinceAdapter = new ArrayAdapter<String>(this,
                R.layout.simple_list_item, new ArrayList<String>(
                cityMap.keySet()));
        ...
        province_spinner
               .setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                   ...
                   public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                       ...
                       ArrayAdapter<String> cityAdater = new ArrayAdapter<String>(
                               seft,R.layout.simple_list_item,cityMap.get(province_name));
                       city_spinner.setAdapter(cityAdater);
                   }
